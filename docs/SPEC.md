...
[콘텐츠 작성 단계 — 5-step 구조 (2026-05-03 수축)]
  Step 1. 기본 설정              (제목·태그·플레이어 수·소요시간 등)
  Step 2. 사건 개요·안내·미디어  (사건 개요·피해자·NPC·오프닝 스토리·라운드별 안내·엔딩 안내·미디어 링크)
  Step 3. 플레이어               (캐릭터 배경·상세 스토리·비밀·관계·타임라인·승점 조건·연관 단서)
  Step 4. 장소 & 단서            (장소·단서 카드·접근 조건)
  Step 5. 투표 & 엔딩            (범인 지정·투표 질문·엔딩 분기·개인 엔딩·작가 후기)
