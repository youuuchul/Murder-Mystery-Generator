...
> 마지막 업데이트: 2026-04-13 (엔딩 퍼널 스포일러 제거, 승점 표시 개선, 폴링/eventLog 퍼포먼스 최적화)
...
| **서버 부하 조사 필요** | library 페이지 응답 4~15s. 누적 세션/eventLog/DB 커넥션 풀 조사 필요 (Supabase MCP로 세션 수/크기 점검) |
