...
> 마지막 업데이트: 2026-04-13 (단서 유형 리워크 Phase 1 완료 — 스키마·normalizer·DB 마이그레이션·기계적 renaming)
...
- [ ] **단서 유형(type) 옵션 리워크** — 동작 기반 2종(owned/shared)으로 재설계. shared는 첫 발견자만 조사회수 1회 차감, 이후 본인/타인 재조사 무료. 플랜: `docs/plans/20260413_CLUE_TYPE_REWORK_PLAN.md`. Phase 1(스키마+DB 마이그레이션) 부터 진행.
